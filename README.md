...
<body>
  ...
  <div class="container mt-5">
    <div class="row">
      ...
      <div class="col-md-4">
        <img src="pharma.png" class="img-fluid" alt="Pharmacy Image">
      </div>
    </div>
  </div>
  <body background="pharmaback.jpeg" style="background-repeat: no-repeat; background-size: cover;">
  <br>
  <br>
  <br>
  <br>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 Pharmaceutical Company. All rights reserved. BY MITHUN KALYAN P(212223040142)</p>
  </footer>
...
<body>
  ...
  <body background="back3.jpeg" style="background-repeat: no-repeat; background-size: cover;"></body>
  <!-- Footer -->
  <footer class="bg-dark text-white text-center py-4 mt-3">
    <p>&copy; 2024 PharmaCompany. All rights reserved.  BY MITHUN KALYAN P(212223040142)</p>
  </footer>
...
<body>
  ...
  <div class="container mt-3">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          <div class="card">
            <img src="med1.jpeg" class="card-img-top" alt="Product 1" width="200" height="200">
            <div class="card-body">
          ...
          <div class="card">
            <img src="med2.jpeg" class="card-img-top" alt="Product 2" width="200" height="200">
            <div class="card-body">
          ...
          <div class="card">
            <img src="med3.jpeg" class="card-img-top" alt="Product 2" width="200" height="200">
            <div class="card-body">
          ...
          <div class="card">
            <img src="med4.jpeg" class="card-img-top" alt="Product 3" width="200" height="200">
            <div class="card-body">
  ...
  <body background="back2.jpeg" style="background-repeat: no-repeat; background-size: cover;">
...
## OUTPUT:
![Screenshot 2024-05-16 125245](https://github.com/MithunKalyan/Pharma/assets/148410106/73e63548-6558-45fb-b9cd-77143ce04a03)

![Screenshot 2024-05-16 130550](https://github.com/MithunKalyan/Pharma/assets/148410106/0b07c59b-f1ad-41c5-8de0-92d85f840b1a)

![Screenshot 2024-05-16 130137](https://github.com/MithunKalyan/Pharma/assets/148410106/fcd7a64d-7bb2-4ff9-9392-f4fe6fe56440)

![Screenshot 2024-05-16 131026](https://github.com/MithunKalyan/Pharma/assets/148410106/e20c0ddf-f35e-4226-b716-ec1a04728f4b)
